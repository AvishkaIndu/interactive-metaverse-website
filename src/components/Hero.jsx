...
const Hero = () => {
  ...
  return (
    <div className='relative h-dvh w-screen overflow-x-hidden'>
      ...
      <h1 className='special-font hero-heading absolute bottom-5 right-5 z-40 text-[#dbeafe]'>G<b>a</b>ming</h1>

      <div className='absolute left-0 top-0 z-40 size-full pointer-events-none'>
        <div className='mt-24 px-5 sm:px-10'>
          <h1 className='special-font hero-heading text-[#dbeafe]'>Ex <b>next gen</b> Gaming</h1>

          <p className='text-[#dbeafe]'>Discover immersive gameplay graphics</p>
          <Button id="watch trailer" title="Watch Trailer" leftIcon={<TiLocationArrow />} containerClass="bg-yellow-300 flex-center gap-1 mt-2" />
