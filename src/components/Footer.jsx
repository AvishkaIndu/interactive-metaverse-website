...
const Footer = () => {
  ...
  const footerLinks = {
    'News': [
      ...
      { name: 'Industry News', href: '#industry' }
    ],
    'Categories': [
      { name: 'PC Gaming', href: '#pc' },
      { name: 'Console Gaming', href: '#console' },
      { name: 'Mobile Gaming', href: '#mobile' },
      { name: 'Esports', href: '#esports' }
    ],
    'Resources': [
      { name: 'Release Calendar', href: '#calendar' },
      { name: 'Game Database', href: '#database' },
      { name: 'Developer Interviews', href: '#interviews' },
      { name: 'Gaming Guides', href: '#guides' }
    ],
    'Company': [
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            <div>
              ...
              <p className="text-white opacity-70 max-w-md mb-6">
                Stay updated with breaking gaming news, exclusive previews, and industry insights. 
            ...
            <div className="lg:text-right">
              <h3 className="text-2xl font-bold text-white mb-4">Gaming News Updates</h3>
              <p className="text-white opacity-70 mb-6">
                Get breaking gaming news, upcoming releases, and exclusive content delivered to your inbox.
              </p>
        ...
        <div className="footer-element border-y border-white/10 py-8 mb-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-white mb-2">2.8K+</div>
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-white mb-2">1.6K+</div>
              <div className="text-white opacity-70 text-sm">Games Covered</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-white mb-2">127+</div>
        ...
        <div className="footer-element">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <div className="font-zentry text-2xl font-bold text-white">GameHub</div>
                <div className="text-white opacity-70 text-sm">Your Gaming News Source</div>
              </div>
            </div>
