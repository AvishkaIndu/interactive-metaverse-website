    ...
    <section id="contact" className="min-h-screen bg-black text-blue-50 py-20">
      <div ref={containerRef} className="container mx-auto px-5 md:px-10">
        <div className="flex flex-col items-center mb-16">
          ...
          <AnimatedTitle 
            title="Ready to sh<b>a</b>re gaming <br /> n<b>e</b>ws updates?"
          ...
          <div className="contact-element mt-8 text-center max-w-2xl">
            <p className="text-white opacity-70 leading-relaxed">
              Got gaming news tips, upcoming game leaks, or want to collaborate? 
              Share your gaming insights and be part of our news community.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="contact-element space-y-8">
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-white">Submit Gaming News</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white opacity-70">game@mail.com</p>
                  </div>
                </div>
          ...
          <div ref={formRef} className="contact-element">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              <h3 className="text-2xl font-bold text-white mb-6">Submit News Tips</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-white/80"
                    placeholder="News category or game title"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Share your gaming news, tips, or exclusive information..."
                  />
                </div>
                
                <div className="flex items-center justify-between">
                  <Button
                    title={isSubmitting ? "Submitting..." : "Submit News Tip"}
